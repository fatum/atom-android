...
public class ISAConfigTest {
	...
	@Test
	public void testGetIBEndPoint() throws
			Exception {
		String token = "token";
	...
	@Test
	public void testGetIBEndPoint2Times() throws
			Exception {
		String token = "token";
	...
	@Test
	public void testGetIBEndPointBulk() throws
			Exception {
		String token = "token";
	...
	// HashTable, and in the second time fetch it from there.
	@Test
	public void testGetEndPointBulk2Times() throws
			Exception {
		String token = "token";
		String customUrl = "http://foo.com/blah_blah";
	...
	@Test
	public void testNotValidUrlWasSavedEndPoint() throws
			Exception {
		String token = "token";
	...
	@Test
	public void testNotValidUrlWasSavedEndPointBulk() throws
			Exception {
		String token = "token";
		String customUrl = "blabla.com";
		String prefKey = String.format("%s_%s", IsaConfig.KEY_IB_END_POINT_BULK, token);

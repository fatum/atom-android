...
class IsaConfig {
    ...
    // Instance lock to make sure this class is a singleton
    private static final Object sInstanceLock = new Object();
    // Default atom url
    protected static final String DEFAULT_URL = "http://track.atom-data.io/";
    // Default atom bulk url
    ...
    // Default SQLite db size
    protected static final int DEFAULT_MAX_DATABASE_LIMIT = KILOBYTE * KILOBYTE * 10;
    ...
    // IronSourceAtomFactory sTracker configuration - for tracking sdk errors
    ...
    void loadConfig(Context context) {
        ...
        maximumDatabaseLimit = isaPrefService.load(KEY_MAX_DATABASE_LIMIT, DEFAULT_MAX_DATABASE_LIMIT);
        bulkSize = isaPrefService.load(KEY_BULK_SIZE, DEFAULT_BULK_SIZE);
    }

    /**
     * Function to set end-point url for report if was set or default IronSourceAtomFactory Url
     *
